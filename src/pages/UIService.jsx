    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-screen flex flex-col justify-end pb-24 px-[5vw] overflow-hidden">
        ...
        <div className="relative z-20 fade-in">
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-4 text-[0.6rem] tracking-[0.3em] text-white/60 font-bold uppercase">
            ...
            <p>OFFERING: MINIMALIST DIGITAL EXPERIENCES</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-[5vw] py-32 grid grid-cols-1 lg:grid-cols-[0.4fr,0.6fr] gap-20 border-t border-white/5">
        <div className="fade-in-up">
          <h2 className="text-white font-bold tracking-[0.3em] text-[0.65rem] mb-10 uppercase">THE ARCHITECTURE</h2>
          <div className="space-y-12">
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">01</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">USER RESEARCH</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE START BY UNDERSTANDING THE USER'S JOURNEY. OUR RESEARCH DEFINES THE FUNCTIONAL REQUIREMENTS AND INTERACTION PATTERNS THAT WILL DRIVE THE DIGITAL EXPERIENCE.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">02</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">WIREFRAMING</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE STRIP AWAY THE VISUALS TO FOCUS ON HIERARCHY AND FLOW. OUR WIREFRAMES ESTABLISH THE SKELETON OF THE PRODUCT, ENSURING THAT THE UX IS INTUITIVE AND EFFICIENT.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fade-in-up delay-200">
          <div className="space-y-12 lg:mt-[168px]">
            <div>
              ...
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">INTERFACE DESIGN</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE APPLY A MINIMALIST AESTHETIC TO THE FUNCTIONAL SKELETON. OUR UI DESIGN FOCUSES ON CLARITY, TYPOGRAPHY, AND WHITESPACE TO CREATE A PREMIUM AND READABLE INTERFACE.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">04</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">PROTOTYPING</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE BUILD HIGH-FIDELITY PROTOTYPES TO VALIDATE THE INTERACTION FLOW. THIS ALLOWS US TO REFINE THE EXPERIENCE BEFORE HANDING OVER ASSETS FOR FINAL DEVELOPMENT.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-[5vw] py-40 bg-white/5 text-center fade-in border-b border-white/5">
        <h2 className="text-[clamp(1.5rem,3.5vw,2.5rem)] font-bold text-white mb-10 tracking-tighter uppercase leading-tight max-w-4xl mx-auto">
          WE DON'T JUST DESIGN SCREENS; WE ARCHITECT DIGITAL INTUITION.
        </h2>
        <p className="text-gray text-xs tracking-[0.4em] uppercase font-bold">FUNCTION • CLARITY • PRECISION</p>
      </section>

      {/* Next Service Link */}
      <section className="py-32 px-[5vw] bg-black text-center group">
        <Link to="/services/social" className="inline-block hover-target">
