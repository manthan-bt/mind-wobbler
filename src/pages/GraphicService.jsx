    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-screen flex flex-col justify-end pb-24 px-[5vw] overflow-hidden">
        ...
        <div className="relative z-20 fade-in">
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-4 text-[0.6rem] tracking-[0.3em] text-white/60 font-bold uppercase">
            ...
            <p>OFFERING: FUNCTIONAL VISUAL COMMUNICATION</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-[5vw] py-32 grid grid-cols-1 lg:grid-cols-[0.4fr,0.6fr] gap-20 border-t border-white/5">
        <div className="fade-in-up">
          <h2 className="text-white font-bold tracking-[0.3em] text-[0.65rem] mb-10 uppercase">THE METHOD</h2>
          <div className="space-y-12">
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">01</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">VISUAL HIERARCHY</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE ORGANIZE INFORMATION TO ENSURE CLARITY AND IMPACT. OUR DESIGN SYSTEM PRIORITIZES READABILITY AND FUNCTIONAL COMMUNICATION.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">02</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">FORM & TYPOGRAPHY</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                EVERY FONT CHOICE AND VECTOR SHAPE IS INTENTIONAL. WE BLEND MINIMALIST AESTHETICS WITH BOLD TYPOGRAPHY TO CREATE ENDURING VISUAL ASSETS.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fade-in-up delay-200">
          <div className="space-y-12 lg:mt-[168px]">
            <div>
              ...
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">LAYOUT ARCHITECTURE</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WHETHER DIGITAL OR PRINT, OUR LAYOUTS ARE BUILT ON RIGOROUS GRIDS. WE ENSURE THAT BALANCE AND WHITESPACE WORK TOGETHER TO ENHANCE THE CORE MESSAGE.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">04</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">FINAL EXECUTION</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE DELIVER HIGH-FIDELITY, PRODUCTION-READY ASSETS. OUR ATTENTION TO DETAIL ENSURES THAT THE FINAL OUTPUT IS FLAWLESS ACROSS ALL PLATFORMS.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-[5vw] py-40 bg-white/5 text-center fade-in border-b border-white/5">
        <h2 className="text-[clamp(1.5rem,3.5vw,2.5rem)] font-bold text-white mb-10 tracking-tighter uppercase leading-tight max-w-4xl mx-auto">
          WE DON'T JUST DESIGN; WE ARCHITECT VISUAL PERSUASION.
        </h2>
        <p className="text-gray text-xs tracking-[0.4em] uppercase font-bold">FORM • FUNCTION • CLARITY</p>
      </section>

      {/* Next Service Link (Loop back to start) */}
      <section className="py-32 px-[5vw] bg-black text-center group">
        <Link to="/services/branding" className="inline-block hover-target">
