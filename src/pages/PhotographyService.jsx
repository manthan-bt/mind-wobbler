    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-screen flex flex-col justify-end pb-24 px-[5vw] overflow-hidden">
        ...
        <div className="relative z-20 fade-in">
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-4 text-[0.6rem] tracking-[0.3em] text-white/60 font-bold uppercase">
            ...
            <p>OFFERING: PRECISION ARCHITECTURAL CAPTURE</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-[5vw] py-32 grid grid-cols-1 lg:grid-cols-[0.4fr,0.6fr] gap-20 border-t border-white/5">
        <div className="fade-in-up">
          <h2 className="text-white font-bold tracking-[0.3em] text-[0.65rem] mb-10 uppercase">THE METHODOLOGY</h2>
          <div className="space-y-12">
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">01</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">SITE ANALYSIS</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE STUDY THE ARCHITECTURAL INTENT AND THE NATURAL LIGHT CYCLE OF THE SPACE. THIS ALLOWS US TO PLAN CAPTURES THAT HIGHLIGHT THE DESIGN'S STRENGTHS AND GEOMETRIC PRECISION.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">02</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">COMPOSITIONAL RIGOR</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                DURING THE SHOOT, WE EMPLOY METICULOUS COMPOSITION AND PERSPECTIVE CONTROL. EVERY FRAME IS ALIGNED TO THE ARCHITECT'S VISION, ENSURING SYMMETRY AND STRUCTURAL INTEGRITY.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fade-in-up delay-200">
          <div className="space-y-12 lg:mt-[168px]">
            <div>
              ...
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">ATMOSPHERIC CAPTURE</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE CAPTURE MULTIPLE EXPOSURES TO MASTER THE RANGE OF LIGHT. OUR FOCUS IS ON TEXTURE, MATERIALITY, AND THE UNIQUE ATMOSPHERE CREATED BY THE INTERACTION OF LIGHT AND SPACE.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">04</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">TECHNICAL REFINEMENT</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                IN POST-PRODUCTION, WE APPLY ADVANCED RETOUCHING AND COLOR BALANCING. WE REFINE EVERY PIXEL TO ENSURE THE FINAL IMAGERY IS AS PRECISE AND IMPACTFUL AS THE ARCHITECTURE ITSELF.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-[5vw] py-40 bg-white/5 text-center fade-in border-b border-white/5">
        <h2 className="text-[clamp(1.5rem,3.5vw,2.5rem)] font-bold text-white mb-10 tracking-tighter uppercase leading-tight max-w-4xl mx-auto">
          WE DON'T JUST TAKE PHOTOS; WE TRANSLATE SPACE INTO SYMMETRY.
        </h2>
        <p className="text-gray text-xs tracking-[0.4em] uppercase font-bold">GEOMETRY • LIGHT • PRECISION</p>
      </section>

      {/* Next Service Link */}
      <section className="py-32 px-[5vw] bg-black text-center group">
        <Link to="/services/motion" className="inline-block hover-target">
