    ...
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-screen flex flex-col justify-end pb-24 px-[5vw] overflow-hidden">
        ...
        <div className="relative z-20 fade-in">
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-4 text-[0.6rem] tracking-[0.3em] text-white/60 font-bold uppercase">
            ...
            <p>OFFERING: STRATEGIC DESIGN & IDENTITY SYSTEMS</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-[5vw] py-32 grid grid-cols-1 lg:grid-cols-[0.4fr,0.6fr] gap-20 border-t border-white/5">
        <div className="fade-in-up">
          <h2 className="text-white font-bold tracking-[0.3em] text-[0.65rem] mb-10 uppercase">THE PROCESS</h2>
          <div className="space-y-12">
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">01</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">STRATEGIC AUDIT</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE COMMENCE EVERY ENGAGEMENT WITH A DEEP ANALYSIS OF YOUR MARKET POSITIONING, COMPETITIVE LANDSCAPE, AND CORE BRAND VALUES. THIS FOUNDATION ENSURES EVERY VISUAL DECISION IS STRATEGICALLY SOUND.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">02</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">VISUAL CONCEPTUALIZATION</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                OUR DESIGNERS EXPLORE MULTIPLE CREATIVE DIRECTIONS, TRANSLATING ABSTRACT STRATEGY INTO TANGIBLE VISUAL CONCEPTS. WE FOCUS ON TYPOGRAPHY, COLOR THEORY, AND ICONOGRAPHY THAT RESONATES.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fade-in-up delay-200">
          <div className="space-y-12 lg:mt-[168px]">
            <div>
              ...
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">SYSTEM DEVELOPMENT</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                ONCE A DIRECTION IS DEFINED, WE BUILD A COMPREHENSIVE VISUAL SYSTEM. THIS INCLUDES EXTENDED ASSETS, MOCKUPS, AND DIGITAL GUIDELINES TO ENSURE FLAWLESS EXECUTION ACROSS ALL CHANNELS.
              </p>
            </div>
            <div>
              <span className="text-white/20 text-4xl font-bold block mb-4">04</span>
              <h3 className="text-white font-bold tracking-tight text-xl mb-4 uppercase">FINAL DEPLOYMENT</h3>
              <p className="text-gray text-[0.7rem] leading-loose tracking-[0.15em] uppercase font-medium">
                WE DELIVER A PRODUCTION-READY BRAND KIT, COMPLETE WITH ALL NECESSARY FORMATS AND A DETAILED BRAND BIBLE. OUR GOAL IS TO EMPOWER YOUR TEAM TO MAINTAIN IDENTITY INTEGRITY.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-[5vw] py-40 bg-white/5 text-center fade-in border-b border-white/5">
        <h2 className="text-[clamp(1.5rem,3.5vw,2.5rem)] font-bold text-white mb-10 tracking-tighter uppercase leading-tight max-w-4xl mx-auto">
          WE DON'T JUST DESIGN LOGOS; WE ENGINEER BRAND PERCEPTION.
        </h2>
        <p className="text-gray text-xs tracking-[0.4em] uppercase font-bold">MINIMALISM • PRECISION • IMPACT</p>
      </section>

      {/* Next Service Link */}
      <section className="py-32 px-[5vw] bg-black text-center group">
        <Link to="/services/cinematography" className="inline-block hover-target">
